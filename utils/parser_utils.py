...
def get_args():
    ...
    parser.add_argument('--model_name', default="allenai/scibert_scivocab_uncased", type=str, help='..')
    ...
    parser.add_argument('--g_out_channels', default=32, type=int, required=False, help='..')
    ...
    parser.add_argument('--dataset_name', type=str, default="ddi2013")
    ...
    for key in list(args_dict.keys()):
        ...
        if str(args_dict[key]).lower() == "true":
            ...
            args_dict[key] = False
        if key == "dataset_path":
            args_dict[key] = os.path.join(args.dataset_path, args_dict[key])
            print(key, os.path.join(args.dataset_path, args_dict[key]))
